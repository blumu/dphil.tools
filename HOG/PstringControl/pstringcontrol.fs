...
type PstringControl =
  class
    ...
    //// Events
    val mutable private nodeClickEvent : Event<PstringControl * NodeClickEventArgs>
    [<CLIEvent>]
    member x.nodeClick with get() = x.nodeClickEvent.Publish
    ...
    new (pstr:pstring) as this =
        {
            ...
            link_anchors=[||]
            edited_node=0
            selected_node= (Array.length pstr)-1
            autosize=true
    ...
    member this.InitializeComponent() =
        ...
        this.nodeEditTextBox.KeyPress.Add (fun e ->  match System.Convert.ToInt32 e.KeyChar with
