...
if "%FSC%"=="" ( set FSC=%FSHARP_HOME%\bin\fscp10.exe )
if "%FSYACC%"=="" ( set FSYACC=%FSHARP_HOME%\bin\fsyaccp10.exe )
if "%FSLEX%"=="" ( set FSLEX=%FSHARP_HOME%\bin\fslexp10.exe )
...
echo ********************************************
echo Monobuild finished, you may now run Hog.exe
echo ********************************************
