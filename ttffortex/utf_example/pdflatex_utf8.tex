...
% The true-type fonts must be installed in the latex texmf/font directory 
% (this can be done using the ttffortex utility from http://william.famille-blum.org/software/latex/index.html)
% The fonts used by this document are:
%   Cyberbit.ttf, simkai.ttf, simhei.ttf, gulim.ttf, batang.ttf, cjsongeb.ttf, ARIALUNI.ttf
%
