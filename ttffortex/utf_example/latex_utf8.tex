% by William Blum.
%
% This file can be compiled with both latex and pdflatex
%
% Prerequisiste: install truetype fonts as follows:
%   ttffortex.cmd   %systemroot%\fonts\simkai.ttf
%   ttffortex.cmd   %systemroot%\fonts\simhei.ttf
%   ttffortex.cmd   %systemroot%\fonts\Cyberbit.ttf
%   ttffortex.cmd   %systemroot%\fonts\gulim.ttc
%   ttffortex.cmd   %systemroot%\fonts\batang.ttc
%   ttffortex.cmd   %systemroot%\fonts\ARIALUNI.ttf
%   ttffortex.cmd   %systemroot%\fonts\cjsongeb.ttf
%
%  In the document refer to the fontname with the same capitalization used in the filename.
%  E.g. use 'Cyberbit' to refer to the font Cyberbit.ttf
%       and 'ARIALUNI' to refer to the font ARIALUNI.ttf.
%
...
\DeclareFontFamily{T1}{ARIALUNI}{}
\DeclareFontShape{T1}{ARIALUNI}{m}{n}{<-> ARIALU00}{}

% we want the Unicode font for normal text also
\DeclareFontFamily{T1}{cjsongb}{}
\DeclareFontShape{T1}{cjsongb}{m}{n}{<-> cjsong00}{}

\begin{document}

\begin{CJK*}{UTF8}{Cyberbit} \CJKtilde
Character given by its unicode number U+4E02:
\Unicode{"4E}{"02}.
\end{CJK*}
