% Can be compiled with both latex and pdflatex
...
\DeclareFontShape{C70}{arial}{m}{n}{<-> CJK * ARIALU}{}
\DeclareFontShape{C70}{arial}{bx}{n}{<-> CJKb * ARIALU}{\CJKbold}
% we want the Unicode font for normal text also
\DeclareFontFamily{T1}{arial}{}
\DeclareFontShape{T1}{arial}{m}{n}{<-> ARIALU00}{} 

\DeclareFontFamily{C70}{song}{}
\DeclareFontShape{C70}{song}{m}{n}{<-> CJK * CJSONG}{}
\DeclareFontShape{C70}{song}{bx}{n}{<-> CJKb * CJSONG}{\CJKbold}
% we want the Unicode font for normal text also
\DeclareFontFamily{T1}{song}{} 
\DeclareFontShape{T1}{song}{m}{n}{<-> CJSONG00}{} 
